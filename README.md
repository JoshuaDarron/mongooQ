...
[![Build Status](https://travis-ci.org/chilts/mongoosejsq.png)](https://travis-ci.org/chilts/mongodb-queue) [![NPM](https://nodei.co/npm/mongoosejsq.png?mini=true)](https://nodei.co/npm/mongodb-queue/)
...
var mongoosejsQ = require('mongoosejsq')
